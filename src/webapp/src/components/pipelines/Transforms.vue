  ...
  methods: {
    saveTransformAndGoToSchedules() {
      this.$store.dispatch('configuration/updateRecentELTSelections', {
        ...
        Vue.toasted.global.success(`Transform Saved - ${this.selectedTransformOption.label}`)
      })
    },
          ...
          <div class="content">
            <article class="message is-info is-small">
              ...
              <div class="message-body">
                <p>Currently, for the UI, we only support the <em>default transforms</em> that ship with Meltano. The CLI however <a href="https://www.meltano.com/docs/tutorial.html#advanced-adding-custom-transformations-and-models">provides more options</a>. Longer term we ancipate this view to support transform creation, editing, and selection.</p>
                <p>Current Options:</p>
                <ul>
                  <li>Run (ELT): run the default transforms with extract and load</li>
                  <li>Skip (EL): do not run the default transforms with extract and load</li>
                  <li>Only (T): only run default transforms, do not extract and load</li>
                </ul>
              </div>
            </article>
          </div>
          ...
          <div class="level">
              <div class="level-left">
                <div class="buttons has-addons">
                  <button
                    ...
                    :class="{
                      'is-selected is-interactive-secondary': transformOption === selectedTransformOption
                    }"
              ...
              <div class="level-right">
                <a
                  ...
                  @click='saveTransformAndGoToSchedules'>Save</a>
              </div>
