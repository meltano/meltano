...
export default {
  ...
  methods: {
    ...
    onChangeInterval(option, pipeline, item) {
      const newPipelineValue = option.srcElement.selectedOptions[0].value
      console.log('pipeline value', newPipelineValue, item)
      ...
      <tbody>
        <template v-for="pipeline in pipelines">
          <tr :key="pipeline.name">
                  ...
                  <div class="control is-expanded">
                    ...
                    >
                      <select
                        ...
                        @change="
                          onChangeInterval($event, pipeline, 'transform')
                        "
                      >
                        <option
                  ...
                  <div class="control is-expanded">
                    ...
                    >
                      <select
                        ...
                        @change="onChangeInterval($event, pipeline, 'interval')"
                      >
                        <option
            ...
            <td>
              <div class="buttons">
                <div class="control run-now-button">
                  <button
