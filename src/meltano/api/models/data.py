    ...
    def serializable(self, include_dimensions_and_measures=False):
        ...
        if include_dimensions_and_measures:
            ...
            for dimension in self.view.dimensions:
                ...
                this_dimension['view_label'] = dimension.settings.get('view_label',
                                                                      ' '.join(dimension.name.split('_')).title())
        ...
        for join in self.joins:
            ...
            this_join['settings']['view_label'] = this_join['settings'].get('view_label', ' '.join(
                this_join['name'].split('_')).title())
