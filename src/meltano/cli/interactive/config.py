...
class InteractiveConfig:
    ...
    def __init__(self, ctx, store, extras=False, max_width=None):  # noqa: ANN001, ANN204, FBT002
    ...
    def _print_home_screen(self):  # noqa: ANN202
    ...
    def _print_setting(self, name, config_metadata, index, last_index):  # noqa: ANN001, ANN202, C901
        """Print setting."""
    ...
    def configure(self, name, index=None, last_index=None, show_set_prompt=True):  # noqa: ANN001, ANN201, FBT002
    ...
    def configure_all(self):  # noqa: ANN201
    ...
    def set_value(self, setting_name, value, store, interactive=False):  # noqa: ANN001, ANN201, FBT002
