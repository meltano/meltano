...
class InteractiveConfig:  # noqa: WPS230, WPS214
    ...
    def _print_setting(self, name, config_metadata, index, last_index) -> None:  # noqa: ANN001, C901
        """Print setting."""
    ...
    def configure(self, name, index=None, last_index=None, show_set_prompt=True):  # noqa: ANN001, ANN201, C901
    ...
    def configure_all(self) -> None:  # noqa: C901
