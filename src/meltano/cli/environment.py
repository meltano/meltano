...
def meltano_environment(project: Project, ctx: click.Context):  # noqa: ANN201
    """
    Manage Environments.
...
@click.argument("name")
@click.pass_context
def add(ctx: click.Context, name: str):  # noqa: ANN201
...
@click.argument("name")
@click.pass_context
def remove(ctx: click.Context, name: str):  # noqa: ANN201
...
@click.pass_context
def list_environments(ctx: click.Context):  # noqa: ANN201
