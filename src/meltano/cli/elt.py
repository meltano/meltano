...
@run_async
async def el(  # WPS408  # noqa: ANN201, PLR0913
    project: Project,
    ctx: click.Context,
    extractor: str,
    loader: str,
    dry: bool,  # noqa: FBT001
...
@pass_project(migrate=True)
@run_async
async def elt(  # WPS408  # noqa: ANN201, PLR0913
    project: Project,
    ctx: click.Context,
    extractor: str,
    loader: str,
...
async def _run_el_command(  # noqa: ANN202, PLR0913
    project: Project,
    ctx: click.Context,
    extractor: str,
    loader: str,
...
def _elt_context_builder(  # noqa: ANN202, PLR0913
    project: Project,
    job,  # noqa: ANN001
    session,  # noqa: ANN001
    ...
    dry_run=False,  # noqa: ANN001, FBT002
    full_refresh=False,  # noqa: ANN001, FBT002
    refresh_catalog=False,  # noqa: ANN001, FBT002
    select_filter=None,  # noqa: ANN001
    catalog=None,  # noqa: ANN001
    state=None,  # noqa: ANN001
    merge_state=False,  # noqa: ANN001, FBT002
):
...
async def dump_file(context_builder, dumpable):  # noqa: ANN001, ANN201
...
async def _run_job(tracker, project, job, session, context_builder, force=False):  # noqa: ANN001, ANN202, FBT002, PLR0913
...
async def _run_elt(  # noqa: ANN202
    tracker: Tracker,
...
async def _run_extract_load(  # noqa: ANN202
    log,  # noqa: ANN001
...
async def _run_transform(log, elt_context, output_logger, **kwargs):  # noqa: ANN001, ANN003, ANN202
    stderr_log = logger.bind(
        run_id=str(elt_context.job.run_id),
        state_id=elt_context.job.job_name,
        stdio="stderr",
