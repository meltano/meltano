...
@pass_project()
def remove(project, plugin_type, plugin_names):  # noqa: ANN001, ANN201
    """
...
def remove_plugins(project, plugins):  # noqa: ANN001, ANN201
...
def remove_plugin_status_update(plugin):  # noqa: ANN001, ANN201
...
def removal_manager_status_update(removal_manager: PluginLocationRemoveManager):  # noqa: ANN201
