...
class ConfigService:
    ...
    def settings(self) -> list[SettingDefinition]:
        ...
        """
        with open(str(bundle.root / "settings.yml")) as settings_yaml:  # noqa: PTH123
    ...
    def update_config(self, config):  # noqa: ANN001, ANN201
    ...
    def make_meltano_secret_dir(self):  # noqa: ANN201
