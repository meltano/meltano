...
import logging
import logging.handlers  # noqa: WPS301
...
class LogRecordStreamHandler(socketserver.StreamRequestHandler):
    ...
    def unPickle(self, data: bytes):  # noqa: N802
        """Unpickle the data.
    ...
    def handleLogRecord(self, record: logging.LogRecord):  # noqa: N802
        ...
        name = (
            ...
            if self.server.logger_name is not None
            else record.name
        )
...
def main():  # noqa: D103
    ...
    print("About to start TCP server...")  # noqa: T201, WPS421
