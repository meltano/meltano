...
class OutputLogger:
    ...
    def __init__(self, file):  # noqa: ANN001, ANN204
...
class LineWriter:
    ...
    def __init__(self, out):  # noqa: ANN001, ANN204
    ...
    def write(self, line):  # noqa: ANN001, ANN201
        """Write a line.
...
class FileDescriptorWriter:
    ...
    def __init__(self, out, fd):  # noqa: ANN001, ANN204
...
class Out:
    ...
    async def _read_from_fd(self, read_fd):  # noqa: ANN001, ANN202
