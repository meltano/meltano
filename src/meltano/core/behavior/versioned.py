...
class IncompatibleVersionError(Exception):
    ...
    def __init__(self, message, file_version: int, version: int):  # noqa: D107
...
class Versioned(ABC):
    ...
    def is_compatible(self, version: int | None = None):  # noqa: D102
        try:
    ...
    def ensure_compatible(self, version: int | None = None):  # noqa: D102
