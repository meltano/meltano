...
class hook:  # noqa: N801
    ...
    def __init__(self, hook_name, can_fail=False):  # noqa: ANN001, ANN204, FBT002, D107
        self.name = hook_name
...
class HookObject(metaclass=Hookable):
    ...
    @classmethod
    async def trigger(cls, target, hook_name, *args, **kwargs):  # noqa: ANN001, ANN002, ANN003, ANN206
