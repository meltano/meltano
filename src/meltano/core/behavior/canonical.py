...
class Canonical(metaclass=AnnotationsMeta):  # (too many methods)
    ...
    def __setattr__(self, attr: str, value: t.Any):  # noqa: ANN204, ANN401
    ...
    def __contains__(self, obj: t.Any):  # noqa: ANN204, ANN401
    ...
    def update(self, *others: t.Any, **kwargs: t.Any) -> None:
        ...
        for other in others:
            other = type(self).as_canonical(other)  # noqa: PLW2901
