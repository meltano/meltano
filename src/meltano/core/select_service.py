...
class SelectService:  # noqa: D101
    ...
    async def load_catalog(self, session, refresh=False):  # noqa: ANN001, ANN201, FBT002
        """Load the catalog."""
    ...
    async def list_all(self, session, refresh=False) -> ListSelectedExecutor:  # noqa: ANN001, FBT002
        """List all select."""
        try:
    ...
    def update(self, entities_filter, attributes_filter, exclude, remove=False):  # noqa: ANN001, ANN201, FBT002
