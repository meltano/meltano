...
class PluginSettingsService(SettingsService):
    ...
    def setting_env_vars(self, setting_def: SettingDefinition, for_writing=False):  # noqa: ANN001, ANN201, FBT002
    ...
    def update_meltano_yml_config(self, config_with_extras):  # noqa: ANN001, ANN201
    ...
    def update_meltano_environment_config(self, config_with_extras: dict[str, t.Any]):  # noqa: ANN201
