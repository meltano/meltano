...
class PluginNotFoundError(Exception):
    ...
    def __init__(self, plugin_or_name):  # noqa: ANN001, ANN204, D107
...
class PluginParentNotFoundError(Exception):
    ...
    def __init__(self, plugin, parent_not_found_error):  # noqa: ANN001, ANN204
...
class InvalidPluginDefinitionError(Exception):
    ...
    def __init__(self, definition=None):  # noqa: ANN001, ANN204
