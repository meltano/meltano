...
class Airflow(BasePlugin):
    ...
    def update_config_file(invoker: AirflowInvoker) -> None:
        ...
        logger.debug(f"Generated default '{str(airflow_cfg_path)}'")  # noqa: G004, RUF010
        ...
        with airflow_cfg_path.open() as airflow_cfg_file_to_read:
            ...
            logger.debug(f"Loaded '{str(airflow_cfg_path)}'")  # noqa: G004, RUF010
        ...
        with airflow_cfg_path.open("w") as airflow_cfg_file_to_write:
            ...
            logger.debug(f"Saved '{str(airflow_cfg_path)}'")  # noqa: G004, RUF010

    @hook("before_install")
    async def setup_env(self, *args, **kwargs):  # noqa: ANN002, ANN003, ANN201, ARG002
    ...
    async def before_configure(self, invoker: AirflowInvoker, session):  # noqa: ANN001, ANN201
    ...
    @hook("before_cleanup")
    async def before_cleanup(self, invoker: PluginInvoker):  # noqa: ANN201
