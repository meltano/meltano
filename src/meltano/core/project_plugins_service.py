...
class ProjectPluginsService:  # (too many methods, attributes)
    ...
    def get_plugins_of_type(
        self,
        plugin_type: PluginType,
        ensure_parent=True,  # noqa: ANN001, FBT002
    ) -> list[ProjectPlugin]:
    ...
    def plugins_by_type(self, ensure_parent=True):  # noqa: ANN001, ANN201, FBT002
    ...
    def plugins(self, ensure_parent=True) -> t.Generator[ProjectPlugin, None, None]:  # noqa: ANN001, FBT002
        """Return all plugins.
    ...
    def update_plugin(self, plugin: ProjectPlugin, keep_config: bool = False):  # noqa: ANN201, FBT001, FBT002
        """Update a plugin.
    ...
    def update_environment_plugin(self, plugin: EnvironmentPluginConfig):  # noqa: ANN201
