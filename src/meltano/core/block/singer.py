...
class InvokerBase:
    ...
    async def start(self, *args, **kwargs):  # noqa: ANN002, ANN003, ANN201
    ...
    async def stop(self, kill: bool = True):  # noqa: ANN201, FBT001, FBT002
    ...
    def stderr_link(self, dst: SubprocessOutputWriter):  # noqa: ANN201
