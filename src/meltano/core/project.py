...
def walk_parent_directories():  # noqa: ANN201
    ...
    while True:
        ...
        parent_directory = os.path.dirname(directory)  # noqa: PTH120
...
class Project(Versioned):
    ...
    def __init__(
        ...
        readonly: bool = False,  # noqa: FBT001, FBT002
    ):
    ...
    def activate(cls, project: Project):  # noqa: ANN206
                ...
                if ctypes.windll.shell32.IsUserAnAdmin():  # type: ignore[attr-defined]
                    if executable.is_file():
                        ...
                        logger.warning(
                            ...
                            f"present in {str(Path(sys.executable).parent)}",  # noqa: RUF010
                        )
                else:
                    logger.warning(
    ...
    @classmethod
    def deactivate(cls):  # noqa: ANN206
    ...
    def find(cls, project_root: Path | str | None = None, activate=True):  # noqa: ANN001, ANN206, FBT002
        """Find a Project.
        ...
        if project_root := project_root or os.getenv(PROJECT_ROOT_ENV):
            ...
            for directory in walk_parent_directories():
                ...
                if project.meltanofile.exists():
                    break
            if not project.meltanofile.exists():
                raise ProjectNotFound(Project(os.getcwd()))  # noqa: PTH109
