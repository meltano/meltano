...
class SingerRunner(Runner):  # noqa: D101
    ...
    async def invoke(  # noqa: ANN201, C901, PLR0912, PLR0913, PLR0915
        self,
        tap: PluginInvoker,
    ...
    def dry_run(self, tap: PluginInvoker, target: PluginInvoker):  # noqa: ANN201, D102
        logger.info("Dry run:")
    ...
    def _handle_tap_line_length_limit_error(  # noqa: ANN202
        self,
