...
class ELTContext:
    ...
    def __init__(  # noqa: PLR0913
        ...
        only_transform: bool | None = False,  # noqa: FBT002
        dry_run: bool | None = False,  # noqa: FBT002
        full_refresh: bool | None = False,  # noqa: FBT002
        refresh_catalog: bool | None = False,  # noqa: FBT002
        select_filter: list | None = None,
        catalog: str | None = None,
        state: str | None = None,
        base_output_logger: OutputLogger | None = None,
        merge_state: bool | None = False,  # noqa: FBT002
    ):
...
class ELTContextBuilder:
    ...
    def with_only_transform(self, only_transform: bool) -> ELTContextBuilder:  # noqa: FBT001
    ...
    def with_dry_run(self, dry_run: bool) -> ELTContextBuilder:  # noqa: FBT001
    ...
    def with_full_refresh(self, full_refresh: bool) -> ELTContextBuilder:  # noqa: FBT001
    ...
    def with_refresh_catalog(self, refresh_catalog: bool) -> ELTContextBuilder:  # noqa: FBT001
    ...
    def with_merge_state(self, merge_state: bool):  # noqa: ANN201, FBT001
    ...
    def set_base_output_logger(self, base_output_logger: OutputLogger):  # noqa: ANN201
