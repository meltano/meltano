...
class StateService:
    ...
    @staticmethod
    def validate_state(state: dict[str, t.Any]):  # noqa: ANN205
    ...
    def add_state(  # noqa: ANN201
        self,
        job: Job | str,
        new_state: str,
        payload_flags: Payload = Payload.STATE,
        validate=True,  # noqa: ANN001, FBT002
    ):
    ...
    def set_state(self, state_id: str, new_state: str, validate: bool = True):  # noqa: ANN201, FBT001, FBT002
    ...
    def clear_state(self, state_id, save: bool = True):  # noqa: ANN001, ANN201, FBT001, FBT002, ARG002
    ...
    def merge_state(self, state_id_src: str, state_id_dst: str):  # noqa: ANN201
    ...
    def copy_state(self, state_id_src: str, state_id_dst: str):  # noqa: ANN201
    ...
    def move_state(self, state_id_src: str, state_id_dst: str):  # noqa: ANN201
