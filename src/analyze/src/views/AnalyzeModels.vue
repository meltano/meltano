...
export default {
  ...
  computed: {
    ...
    ...mapGetters('repos', ['urlForModelDesign', 'hasModels']),
  },
  filters: {
    capitalize,
    underscoreToSpace,
  ...
  <section>
    <div class="message is-warning">
      <div class="message-body">
        <p>
          This UI temporarily requires a model in order to display analysis options. For more information on how to add models, check out our
          <docs-link page="architecture" fragment="model">documentation for models</docs-link>.
        </p>
        <p class="is-italic">
    ...
    <article v-if="!hasModels" class="message is-info is-small">
      ...
      <div class="message-body">
        <p class="content">
          Use
          <code>meltano add model</code> to add models to your current project.
          See the
          <docs-link page="tutorial" fragment="initialize-your-project">documentation</docs-link>for more details.
        </p>
      </div>
    </article>
