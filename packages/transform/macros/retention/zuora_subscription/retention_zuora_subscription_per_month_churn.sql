{% macro retention_zuora_subscription_per_month_churn(n) %}
...
WITH zuora_subs AS (
    ...
    {% for the_month in range(0, n + 1) %}
        ...
        {{ retention_zuora_subscription_churn_history_cte_calc(the_month) }}
    ...
    {% for the_month in range(0, n + 1) %}
        ...
        {{ retention_zuora_subscription_churn_history_select_calc(the_month) }}
