...
by using [`BashOperator`](https://airflow.apache.org/docs/apache-airflow/2.0.1/howto/operator/bash.html)
with the [`meltano elt` command](/docs/command-line-interface.html#elt), or
[`DockerOperator`](https://airflow.apache.org/docs/apache-airflow-providers-docker/1.0.1/_api/airflow/providers/docker/operators/docker/index.html)
