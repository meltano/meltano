  ...
  <div class="home">
    <div class="hero">
      ...
      <div class='jump-in'>
        ...
        <div class="language-bash extra-class"><pre class="language-bash"><code>pip <span class="token function">install</span> meltano</code></pre><span class="code-block-copy-button code-block-copy-button-offset" title="Copy to clipboard"></span></div>
      </div>
    </div>
