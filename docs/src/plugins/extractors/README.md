...
You can easily add [any existing Singer tap](https://www.singer.io/#taps) as a [custom extractor](/#how-to-add-extractors-and-loaders-to-your-project) or [create your own from scratch](/tutorials/create-a-custom-extractor.html).
:::
