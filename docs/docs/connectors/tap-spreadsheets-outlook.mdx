...
> **Note for whoever finalises this page:** as with the SharePoint page, the source material didn't specify incremental vs. full-table sync behaviour. Fill that in before publishing.
