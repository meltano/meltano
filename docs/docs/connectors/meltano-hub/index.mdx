...
- The plugin isn't on the Hub yet - for example, a tap you're still developing. (When it's ready, you can [add it to the Hub](/connectors/meltano-hub/add-a-plugin).)
...
- [Add a plugin to Meltano Hub](/connectors/meltano-hub/add-a-plugin) - get your own connector listed
- [Maintaining taps and targets](/connectors/meltano-hub/maintaining-plugins) - best practices, evaluating connectors, and adopting an unmaintained one
