...
- The plugin isn't on the Hub yet - for example, a tap you're still developing. (When it's ready, you can [list it on the Hub](/connectors/meltano-hub/add-a-plugin).)
...
- [Listing on the Hub](/connectors/meltano-hub/add-a-plugin) - get your own connector listed
- [Maintaining Taps & Targets](/connectors/meltano-hub/maintaining-plugins) - best practices, evaluating connectors, and adopting an unmaintained one
