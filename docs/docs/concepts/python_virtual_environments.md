...
See our [Installation Guide](/meltano-open/installation) for more details.
...
Ensure you have `pipx` installed by reviewing the <a href="/meltano-open/installation#install-pipx">Install pipx</a> instructions.</p>
:::
