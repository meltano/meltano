...
If the catalog does not seem to take effect, you may need to [validate the capabilities of the tap](/guide/troubleshooting#validate-tap-capabilities).
...
#### <Link id="load-schema-extra"/>`load_schema` extra
...
#### <Link id="select-filter-extra"/>`select_filter` extra
...
#### <Link id="cache-catalog-extra"/>`use_cached_catalog` extra
...
#### <Link id="package-name-extra"/>`package_name` extra
