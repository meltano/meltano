...
In this case, you will need to update the extractor in your project - by maintaining your plugin definition YAML file in line with changes to the tap as you go, this is a simple process of running the previous command along with the `--update` flag:
