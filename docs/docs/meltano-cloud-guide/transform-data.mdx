...
dbt models require the source tables to exist before they can run. If the raw data is not yet in your data store, you will need to [run your data import locally](/docs/how-to-guides/import-data#running-your-data-import-locally) first.
