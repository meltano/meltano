...
sidebar_label: Setup your Development Environment
sidebar_position: 4
---
...
Any changes you make locally can be committed and pushed back to the remote repository. If you have a GitHub Webhook configured, those changes will be picked up and deployed to your workspace automatically. See the [Managing Config from GitHub](/docs/how-to-guides/manage-workspaces#managing-config-from-github) guide for setup instructions.
