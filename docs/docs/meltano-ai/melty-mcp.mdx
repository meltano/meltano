...
:::info Availability
Melty MCP is awaiting listing in Claude's connector directory, so the search step below won't find it yet. If you'd like access before it's listed, email [support@meltano.com](mailto:support@meltano.com).
:::
...
Questions, or something in a reply that looks wrong? Email [support@meltano.com](mailto:support@meltano.com) or reach out through your usual support channel.
