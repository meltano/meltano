...
For runs that already executed on Cloud, open the pipeline in the **Pipelines** view and read its logs directly, or use **Diagnose** for the same plain-language read the agent gives you locally, see [AI Diagnostics](./ai-diagnostics.mdx).
