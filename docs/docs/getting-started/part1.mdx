...
import Termy from '../../src/utils/Termy'
...
<Termy options={{ lineDelay: 500 }}>
  <div lineData={{ type: 'input' }}>meltano --version</div>
  <div lineData={{ type: 'output' }}>meltano, version 2.19.0</div>
</Termy>
...
<Termy options={{ lineDelay: 500 }}>
  <div lineData={{ type: 'input' }}>meltano init my-new-project</div>
  <div lineData={{ type: 'output' }}>
