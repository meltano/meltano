...
## <Link id="add-an-extractor-to-pull-data-from-a-source"/>Add an Extractor to Pull Data from a Source
...
## <Link id="add-a-loader-to-send-data-to-a-destination"/>Add a dummy loader to dump the data into JSON
