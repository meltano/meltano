...
1. Do you want to [save this data temporarily in a CSV and then run a Python script to transform it?](/getting-started/a-part2).
...
3. Do you want to [load this data into a data warehouse (postgres) and then use dbt to transform it?](/getting-started/c-part2).
