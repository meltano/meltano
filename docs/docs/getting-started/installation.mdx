...
:::tip Upgrading Meltano

To upgrade to the latest version, use `uv tool upgrade meltano`, `pipx upgrade meltano`, `pip install --upgrade meltano`, or pull the latest Docker image.
