...
Now that [your Meltano project](/getting-started/part1#create-your-meltano-project), [extractor](/getting-started/part1#add-an-extractor-to-pull-data-from-a-source), and [loader](/getting-started/part1#add-a-loader-to-send-data-to-a-destination) are all set up, it's time to run your first data integration (EL) pipeline!
