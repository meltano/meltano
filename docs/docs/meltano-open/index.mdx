---
title: Meltano Open
description: Information about the Meltano Open edition.
layout: doc
toc: false
...
<ul>
<li><a href="/meltano-open/meltano-at-a-glance">Overview</a></li>
<li><a href="/meltano-open/installation">Self-host install</a></li>
...
<li><a href="/guide/v4-migration">Meltano 4.0 Migration Guide</a></li>
...
<li><a href="/guide/user-yaml-config">User YAML Configuration</a></li>
