...
The `meltano` repo uses the [semantic-prs](https://github.com/Ezard/semantic-prs) GitHub app to check all PRs against the [conventional commit](https://www.conventionalcommits.org/en/v1.0.0/) syntax.
