...
1. [Python 3.8+](https://www.python.org/downloads/). For more details about Python requirements, refer to the ["Requirements" section](/getting-started/installation-guide#requirements) of the Installation instructions, that also apply here.
