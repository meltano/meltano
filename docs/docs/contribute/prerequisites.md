...
1. [Python 3.10+](https://www.python.org/downloads/). For more details about Python requirements, refer to the ["Requirements" section](/meltano-open/installation#requirements) of the Installation instructions, that also apply here.
