...
description: Add whitelist ip ranges nad key pair authentication
layout: doc
sidebar_position: 15
---
...
* Developers
* Data ingestion services like Matatika
* Other trusted applications

The Matatika platform is hosted in an Azure data center within the United Kingdom and connects from the following IP address:
