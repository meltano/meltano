...
This section covers how to manage your Meltano workspace configuration across five key areas: syncing config from GitHub, using environments to separate settings by stage, promoting changes through a DataOps workflow, speeding up pipelines with a custom Docker image, and controlling the Lab landing page.
...
## Controlling the Lab Landing Page {#controlling-the-lab-landing-page}
