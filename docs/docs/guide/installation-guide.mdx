...
This document will get you up and running with Meltano in-depth. There is also a [short install guide for first-time Meltano users](/meltano-open/installation).
