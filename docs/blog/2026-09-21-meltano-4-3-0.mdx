...
The configured Hub plugin catalog can be searched and inspected directly from the CLI:
...
```
When authenticated, Meltano uses the Meltano Cloud Hub plugin catalog to resolve plugin definitions and their default variants. For example:
