...
NOTE-The Meltano Cloud Hub plugin catalog can specify a different default variant from the public Hub while still allowing users to select another variant when needed.
