...
### Curated Meltano Cloud Hub Plugin Catalog

When you're authenticated with Meltano Cloud, `meltano hub list` uses the Meltano Cloud Hub plugin catalog instead of the public Hub catalog.

The Meltano Cloud Hub plugin catalog contains plugins that Meltano supports, maintains, and tests. This gives users a curated starting point when choosing plugins for their projects.
