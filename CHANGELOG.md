...
- [#3391](https://gitlab.com/meltano/meltano/-/issues/3391) Resolve issue where `run` would invoke the wrong plugin command when the same plugin is used multiple times.
