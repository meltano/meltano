...
### New
* [#867](https://gitlab.com/meltano/meltano/issues/867) Add defaults for `start date`, `start time`, and `end date` for all connectors so the user has potentially one less interaction to make per connector configuration
