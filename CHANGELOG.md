...
- [#10335](https://github.com/meltano/meltano/issues/10335) Read the Hub that Meltano Cloud serves once logged in
- [#10333](https://github.com/meltano/meltano/issues/10333) List plugins available on Meltano Hub with `meltano hub list`
- [#10328](https://github.com/meltano/meltano/issues/10328) Authenticate Hub requests with a Meltano Cloud account
- [#10330](https://github.com/meltano/meltano/issues/10330) List project plugins with `meltano plugin list`
- [#10283](https://github.com/meltano/meltano/issues/10283) Support `.python-version` file for plugin installs -- _**Thanks @nanjeshramesh!**_
...
- [#10148](https://github.com/meltano/meltano/issues/10148) Allow `MELTANO_RUN_FORCE` environment variable to be used as an alternative `meltano run --force` flag
...
- [#10075](https://github.com/meltano/meltano/issues/10075) Process exception notes in Singer SDK structured logs
...
- [#10020](https://github.com/meltano/meltano/issues/10020) Add `meltano state export` and `meltano state import` commands
...
- [#10334](https://github.com/meltano/meltano/issues/10334) Render `meltano logs list` like other listing commands
- [#10319](https://github.com/meltano/meltano/issues/10319) Ensure systemdb connection is closed in early connectivity test
- [#10264](https://github.com/meltano/meltano/issues/10264) Stop redirecting away from the DataML and Cloud API reference pages
...
- [#10182](https://github.com/meltano/meltano/issues/10182) Prevent include_paths from escaping project root
- [#10167](https://github.com/meltano/meltano/issues/10167) Ensure project `.env` files are created with 0600 permissions
- [#10155](https://github.com/meltano/meltano/issues/10155) Correctly propagate SIGTERM to plugin subprocesses
- [#10131](https://github.com/meltano/meltano/issues/10131) Allow smart-open 8.x
- [#10118](https://github.com/meltano/meltano/issues/10118) Disable colors when stderr is not a TTY -- _**Thanks @gbadedata!**_
- [#10104](https://github.com/meltano/meltano/issues/10104) Avoid swallowing Pipelinewise plugin logs by setting the level for the root logger
- [#10103](https://github.com/meltano/meltano/issues/10103) Allow structlog to 26.x
- [#10100](https://github.com/meltano/meltano/issues/10100) Ensure stdlib logging `extra` values are added to the object when the JSON log formatter is used
- [#10089](https://github.com/meltano/meltano/issues/10089) Output more detailed errors when requests to the Hub API fail
...
- [#10036](https://github.com/meltano/meltano/issues/10036) Make logging less noisy when listing state IDs from a filesystem-based state backend
- [#10032](https://github.com/meltano/meltano/issues/10032) Allow Click 8.4.x
- [#10029](https://github.com/meltano/meltano/issues/10029) Ensure custom dotenv file is preserved in project instance and `--env-file` is honored
- [#10013](https://github.com/meltano/meltano/issues/10013) Check if the stdlib (and not structlog) logger is enabled for DEBUG to log Singer stdout
- [#10006](https://github.com/meltano/meltano/issues/10006) Avoid displaying noisy traceback when passing a bad plugin type
...
- [#10213](https://github.com/meltano/meltano/issues/10213) Raise more consistent errors when a schedule, environment or plugin variant is not found
- [#10198](https://github.com/meltano/meltano/issues/10198) Bump Ruff to 0.16 and apply fixes
- [#10166](https://github.com/meltano/meltano/issues/10166) Standardize ruamel.yaml imports
- [#10165](https://github.com/meltano/meltano/issues/10165) Remove obsolete pidfile utility module
- [#10163](https://github.com/meltano/meltano/issues/10163) Remove the `meltano.__version__` variable in favor of `meltano.core.utils.get_meltano_version`
- [#10154](https://github.com/meltano/meltano/issues/10154) Remove dev-only setting resolution debug logs
- Use `itertools.starmap` to construct plugin list
- Use `set.update` instead of `set.add` in a loop
- Avoid prefixing non-dummy variables with `_`
- Replace lambda with `operator.itemgetter`
- [#10121](https://github.com/meltano/meltano/issues/10121) Replace `metaclass=abc.ABCMeta` with `abc.ABC`
- [#10120](https://github.com/meltano/meltano/issues/10120) Unify log configurations between formatters available in `logging.yaml` and the default preset configs (`colored`, `json`, etc.)
- [#10069](https://github.com/meltano/meltano/issues/10069) Apply missing `@override` to the rest of the codebase
- [#10068](https://github.com/meltano/meltano/issues/10068) Apply missing `@override` decorators to `meltano.core.plugin`
- [#10066](https://github.com/meltano/meltano/issues/10066) Apply missing `@override` decorators to first-party state backend implementations
- [#10012](https://github.com/meltano/meltano/issues/10012) Make `meltano.core.logging.utils.SafeStreamHandler` opt-in and document how to use it
- [#10007](https://github.com/meltano/meltano/issues/10007) Decouple Hub error handling from Requests
- [#10004](https://github.com/meltano/meltano/issues/10004) Use global constant for the state file name `state.json`
- [#9974](https://github.com/meltano/meltano/issues/9974) Split virtualenv functionality into venv and package management components

### 📚 Documentation Improvements

- [#10314](https://github.com/meltano/meltano/issues/10314) New AI Diagnostics page
- [#10253](https://github.com/meltano/meltano/issues/10253) Add elt vs run guide for replication workloads -- _**Thanks @br413!**_
- [#10261](https://github.com/meltano/meltano/issues/10261) Use a splat redirect to support all matatika.com connectors on meltano.com
- [#10133](https://github.com/meltano/meltano/issues/10133) Updated connector documentation
- [#10231](https://github.com/meltano/meltano/issues/10231) Add MotherDuck setup instructions
- [#10122](https://github.com/meltano/meltano/issues/10122) Bump Docusaurus to 3.10.1
- [#10092](https://github.com/meltano/meltano/issues/10092)  release updated docs 11 06 2026
- [#10088](https://github.com/meltano/meltano/issues/10088) Update snowflake guides
- [#10062](https://github.com/meltano/meltano/issues/10062) Add Postman collection
- Update dbt-ext in examples
- [#10053](https://github.com/meltano/meltano/issues/10053) Fix display of reference index admonition
- [#10052](https://github.com/meltano/meltano/issues/10052) Add Cloud docs to reference index
- [#10041](https://github.com/meltano/meltano/issues/10041) Meltano Cloud
- [#10022](https://github.com/meltano/meltano/issues/10022) Document `meltano state export` and `meltano state import`

## v4.2.2 (2026-07-22)

### 🐛 Fixes

- [#10190](https://github.com/meltano/meltano/issues/10190) Prevent include_paths from escaping project root (#10182)
