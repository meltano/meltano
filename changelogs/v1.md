...
- [#2087](https://gitlab.com/meltano/meltano/-/issues/2087) Skip plugins that are not configurable or invocable when finding plugin by name in `meltano config` and `meltano invoke`
...
- [#2085](https://gitlab.com/meltano/meltano/-/issues/2085) Don't change order of object and set values when meltano.yml is updated programmatically
...
- [#1574](https://gitlab.com/meltano/meltano/issues/1574) Fix an issue with Meltano crashing after a successful login
...
- [#1466](https://gitlab.com/meltano/meltano/issues/1466) Filters now have clear language and indication that they use AND for chaining
...
- [#1183](https://gitlab.com/meltano/meltano/issues/1183) Fix a race condition causing the `meltano.yml` to be empty in some occurrence
...
- [#1115](https://gitlab.com/meltano/meltano/issues/1115) Update 'meltano permissions' to not require an identically named role for a given user
