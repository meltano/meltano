...
class TestCliUpgrade:
    ...
    def test_upgrade(self, cli_runner: CliRunner):  # noqa: ANN201
    ...
    @pytest.mark.usefixtures("project")
    def test_upgrade_skip_package(self, cli_runner: CliRunner):  # noqa: ANN201
    ...
    @pytest.mark.usefixtures("project")
    def test_upgrade_package(self, cli_runner: CliRunner):  # noqa: ANN201
        if platform.system() == "Windows":
            pytest.xfail(
                "Fails on Windows: https://github.com/meltano/meltano/issues/3444",
            )
    ...
    def test_upgrade_files(self, project, cli_runner: CliRunner):  # noqa: ANN001, ANN201
        if platform.system() == "Windows":
            pytest.xfail(
                "Fails on Windows: https://github.com/meltano/meltano/issues/3444",
            )
    ...
    @pytest.mark.usefixtures("session")
    def test_upgrade_files_glob_path(self, project, cli_runner: CliRunner):  # noqa: ANN001, ANN201
        if platform.system() == "Windows":
            pytest.xfail(
                "Fails on Windows: https://github.com/meltano/meltano/issues/3444",
            )
    ...
    @pytest.mark.usefixtures("project")
    def test_upgrade_database(self, cli_runner: CliRunner):  # noqa: ANN201
        result = cli_runner.invoke(cli, ["upgrade", "database"])
        assert_cli_runner(result)

    @mock_aws
    @pytest.mark.usefixtures("project")
    def test_upgrade_state(self, cli_runner, monkeypatch):  # noqa: ANN001, ANN201
