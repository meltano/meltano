...
class TestCliJob:
    ...
    def test_job_add(self, cli_runner, task_sets_service):  # noqa: ANN001, ANN201
    ...
    @pytest.mark.usefixtures("session", "project")
    def test_job_set(self, cli_runner, task_sets_service):  # noqa: ANN001, ANN201
        # singular task with job
        with mock.patch(
            "meltano.cli.job.TaskSetsService",
            return_value=task_sets_service,
    ...
    @pytest.mark.usefixtures("session", "project")
    def test_job_remove(self, cli_runner, task_sets_service):  # noqa: ANN001, ANN201
        # singular task with job
        with mock.patch(
            "meltano.cli.job.TaskSetsService",
            return_value=task_sets_service,
    ...
    @pytest.mark.usefixtures("session", "project")
    def test_job_list(self, cli_runner, task_sets_service):  # noqa: ANN001, ANN201
        # singular task with job
        with mock.patch(
            "meltano.cli.job.TaskSetsService",
            return_value=task_sets_service,
