...
class TestCliInit:
    def test_init(self, cli_runner, tmp_path_factory, pushd):  # noqa: ANN001, ANN201
    ...
    def test_init_existing_empty_directory(self, cli_runner, tmp_path_factory, pushd):  # noqa: ANN001, ANN201
        new_project_root = tmp_path_factory.mktemp("new_meltano_root")
        pushd(new_project_root)
    ...
    def test_init_existing_meltano_yml(self, cli_runner, tmp_path_factory, pushd):  # noqa: ANN001, ANN201
        new_project_root = tmp_path_factory.mktemp("new_meltano_root")
