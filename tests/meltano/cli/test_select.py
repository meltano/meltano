...
class TestCliSelect:
    ...
    def test_update_select_pattern(self, cli_runner, tap):  # noqa: ANN001, ANN201
        # add select pattern
    ...
    @pytest.mark.usefixtures("project")
    def test_select_list(self, cli_runner, tap, monkeypatch: pytest.MonkeyPatch):  # noqa: ANN001, ANN201
