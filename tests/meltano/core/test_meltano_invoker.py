...
class TestMeltanoInvoker:
    ...
    def test_invoke(self, subject: MeltanoInvoker):  # noqa: ANN201
    ...
    def test_env(self, subject: MeltanoInvoker, monkeypatch: pytest.MonkeyPatch):  # noqa: ANN201
    ...
    def test_invoke_executable(self, subject: MeltanoInvoker, project: Project):  # noqa: ANN201
        if platform.system() == "Windows":
            pytest.xfail(
                "Fails on Windows: https://github.com/meltano/meltano/issues/3444",
            )
