...
def test_notable_flag_env_vars(monkeypatch: pytest.MonkeyPatch):  # noqa: ANN201
    ...
    check(("Yes", "TRUE", "1", "true", "y", "on", "t"), True)  # noqa: FBT003
    check(("No", "FALSE", "0", "false", "n", "off", "f"), False)  # noqa: FBT003
    check(("trew", "Fallse", "nah", "si", "okay", "01"), None)


def test_notable_hashed_env_vars(monkeypatch: pytest.MonkeyPatch):  # noqa: ANN201
