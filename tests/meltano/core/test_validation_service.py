...
class MockValidationsRunner(ValidationsRunner):
    async def run_test(self, name: str):  # noqa: ANN201, ARG002
        return 1


class TestValidationsRunner:
    @pytest.mark.asyncio()
    async def test_run_all(self, session, dbt, plugin_invoker_factory):  # noqa: ANN001, ANN201
    ...
    def test_collect_tests(self, project: Project):  # noqa: ANN201
