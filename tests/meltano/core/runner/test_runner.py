    ...
    @pytest.mark.parametrize(
        ...
        (
            pytest.param(
                ...
                [],
                Payload.STATE,
                id="incremental-no-merge-no-select",
            ),
            pytest.param(
                True,
                False,
                [],
                Payload.STATE,
                id="full-refresh-no-merge-no-select",
            ),
            pytest.param(
                False,
                False,
                ["entity"],
                Payload.STATE,
                id="incremental-no-merge-select",
            ),
            pytest.param(
                True,
                False,
                ...
                id="full-refresh-no-merge-select",
            ),
            pytest.param(
                False,
                True,
                [],
                Payload.INCOMPLETE_STATE,
                id="incremental-merge-no-select",
            ),
            pytest.param(
                True,
                True,
                [],
                Payload.INCOMPLETE_STATE,
                id="full-refresh-merge-no-select",
            ),
            pytest.param(
                False,
                True,
