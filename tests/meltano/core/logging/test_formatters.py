...
class FakeCode:
    ...
    def __init__(self, co_filename, co_name):  # noqa: ANN001, ANN204
...
class FakeFrame:
    ...
    def __init__(self, f_code, f_globals, f_locals=None):  # noqa: ANN001, ANN204
        self.f_code = f_code
...
class FakeTraceback:  # pragma: no cover
    ...
    def __init__(self, frames, line_nums):  # noqa: ANN001, ANN204
...
class TestLogFormatters:
    ...
    def test_console_log_formatter_colors(self, record):  # noqa: ANN001, ANN201
        formatter = console_log_formatter(colors=True)
        assert ANSI_RE.match(formatter.format(record))

    def test_console_log_formatter_no_colors(self, record):  # noqa: ANN001, ANN201
        formatter = console_log_formatter(colors=False)
        assert not ANSI_RE.match(formatter.format(record))

    def test_console_log_formatter_no_locals(self, record_with_exception):  # noqa: ANN001, ANN201
    ...
    def test_console_log_formatter_show_locals(self, record_with_exception):  # noqa: ANN001, ANN201
