...
def assert_extractor_env(extractor, env):  # noqa: ANN001, ANN201
...
def assert_loader_env(loader, env):  # noqa: ANN001, ANN201
...
def assert_transform_env(transform, env):  # noqa: ANN001, ANN201
...
def assert_transformer_env(transformer, env):  # noqa: ANN001, ANN201
...
class TestELTContext:
    ...
    @pytest.mark.asyncio()
    async def test_extractor(self, elt_context, session, tap):  # noqa: ANN001, ANN201
    ...
    @pytest.mark.asyncio()
    async def test_loader(self, elt_context, session, target_postgres):  # noqa: ANN001, ANN201
    ...
    async def test_transformer(  # noqa: ANN201
        self,
    ...
    @pytest.mark.asyncio()
    async def test_select_filter(self, elt_context, session):  # noqa: ANN001, ANN201
