...
class TestPluginInvoker:
    ...
    @pytest.mark.asyncio()
    async def test_env(self, project, tap, session, plugin_invoker_factory):  # noqa: ANN001, ANN201
    ...
    @pytest.mark.asyncio()
    async def test_environment_env(  # noqa: ANN201
        self,
    ...
    @pytest.mark.asyncio()
    async def test_expanded_environment_env(  # noqa: ANN201
        self,
        project_with_environment,  # noqa: ANN001
        tap,  # noqa: ANN001
        session,  # noqa: ANN001
    ...
    @pytest.mark.asyncio()
    async def test_unknown_command(self, plugin_invoker):  # noqa: ANN001, ANN201
    ...
    def test_expand_exec_args(self, plugin_invoker):  # noqa: ANN001, ANN201
    ...
    def test_expand_command_exec_args(self, plugin_invoker):  # noqa: ANN001, ANN201
        exec_args = plugin_invoker.exec_args(
            "extra",
            "args",
            command="cmd",
    ...
    @pytest.mark.asyncio()
    async def test_undefined_env_var(self, plugin_invoker):  # noqa: ANN001, ANN201
    ...
    def test_alternate_command_executable(self, plugin_invoker):  # noqa: ANN001, ANN201
        exec_args = plugin_invoker.exec_args(
            "extra",
            "args",
    ...
    @pytest.mark.asyncio()
    async def test_expand_nonpip_command_exec_args(  # noqa: ANN201
        self,
