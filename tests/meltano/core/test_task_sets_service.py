...
class TestTaskSetsService:
    ...
    @pytest.mark.order(0)
    def test_add(self, subject: TaskSetsService, create_task_set):  # noqa: ANN001, ANN201
        count = 10
    ...
    def test_update(self, subject: TaskSetsService, create_task_set):  # noqa: ANN001, ANN201
        job = subject.list()[0]
    ...
    def test_remove(self, subject: TaskSetsService):  # noqa: ANN201
        jobs = subject.list()
    ...
    @pytest.mark.usefixtures("create_task_set")
    def test_get(self, subject: TaskSetsService):  # noqa: ANN201
        jobs = subject.list()
    ...
    @pytest.mark.usefixtures("create_task_set")
    def test_exists(self, subject: TaskSetsService):  # noqa: ANN201
        job = subject.list()[0]
        assert subject.exists(job.name)
        assert not subject.exists("non-existent")

    def test_list(self, subject: TaskSetsService, create_task_set):  # noqa: ANN001, ANN201
