...
class TestPluginDefinition:
    ...
    def test_init_minimal(self):  # noqa: ANN201
    ...
    def test_init_basic(self):  # noqa: ANN201
    ...
    def test_init_variants(self):  # noqa: ANN201
        ...
        assert len(plugin_def.variants) == 2  # noqa: PLR2004
    ...
    def test_canonical(self, attrs_key):  # noqa: ANN001, ANN201
        attrs = self.ATTRS[attrs_key]
        plugin_def = PluginDefinition(PluginType.EXTRACTORS, **attrs)
        assert plugin_def.canonical() == attrs

    def test_find_variant(self):  # noqa: ANN201
    ...
    def test_variant_labels(self):  # noqa: ANN201
        plugin_def = PluginDefinition(PluginType.EXTRACTORS, **self.ATTRS["variants"])

        assert plugin_def.variant_labels == "meltano (default), singer-io (deprecated)"

    def test_label(self):  # noqa: ANN201
    ...
    def test_logo_url(self):  # noqa: ANN201
        plugin_def = PluginDefinition(
            PluginType.EXTRACTORS,
            name="tap-foo",
            namespace="tap_foo",
...
class TestBasePlugin:
    ...
    def test_getattr(self, subject, plugin_def, variant):  # noqa: ANN001, ANN201
    ...
    def test_variant(self, subject, variant):  # noqa: ANN001, ANN201
        assert subject.variant == variant.name

        variant.name = None
        assert subject.variant is None

    def test_extras(self, subject):  # noqa: ANN001, ANN201
        assert subject.extras == {"foo": "bar", "baz": "qux"}

    def test_extra_settings(self, subject):  # noqa: ANN001, ANN201
...
class TestProjectPlugin:
    ...
    def test_init_custom(self):  # noqa: ANN201
    ...
    def test_init_inherited(self):  # noqa: ANN201
    ...
    def test_parent(self, inherited_tap):  # noqa: ANN001, ANN201
    ...
    def test_set_parent(self):  # noqa: ANN201
    ...
    def test_variant(self, project: Project):  # noqa: ANN201
    ...
    def test_command_inheritance(self, tap, inherited_tap):  # noqa: ANN001, ANN201
        # variants
    ...
    def test_command_test(self, tap: BasePlugin):  # noqa: ANN201
    ...
    def testenv_prefixes(self, inherited_tap, tap):  # noqa: ANN001, ANN201
    ...
    def test_config_with_extras(self):  # noqa: ANN201
    ...
    def test_settings(self, tap):  # noqa: ANN001, ANN201
    ...
    def test_extra_settings(self, tap):  # noqa: ANN001, ANN201
    ...
    def test_requirements(self, transformer: ProjectPlugin):  # noqa: ANN201
...
class TestPluginType:
    def test_properties(self):  # noqa: ANN201
    ...
    def test_specfic_properties(self):  # noqa: ANN201
    ...
    def test_from_cli_argument(self):  # noqa: ANN201
        for plugin_type in PluginType:
