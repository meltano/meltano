...
class TestCommand:
    ...
    def test_serialize(self, commands):  # noqa: ANN001, ANN201
    ...
    def test_deserialize(self, commands):  # noqa: ANN001, ANN201
        serialized = Command.parse_all(commands)
    ...
    def test_expanded_args(self):  # noqa: ANN201
    ...
    def test_undefined_env_var(self):  # noqa: ANN201
