...
def test_deep_merge(parent, children, expected):  # noqa: ANN001, ANN201
    assert deep_merge(parent, *children) == expected


class TestProjectFiles:
    @pytest.mark.order(1)
    def test_resolve_subfiles(self, project_files):  # noqa: ANN001, ANN201
    ...
    def test_resolve_from_subdir(self, project_files, cd_temp_subdir):  # noqa: ANN001, ANN201
    ...
    def test_resolve_from_any_dir(self, project_files, cd_temp_dir):  # noqa: ANN001, ANN201
        if platform.system() == "Windows":
            pytest.xfail(
                "Fails on Windows: https://github.com/meltano/meltano/issues/3444",
            )
    ...
    @pytest.mark.order(5)
    def test_load(self, project_files):  # noqa: ANN001, ANN201
        expected_result = {
            "version": 1,
            "default_environment": "test-meltano-environment",
            "database_uri": "sqlite:///.meltano/meltano.db",
    ...
    @pytest.mark.order(6)
    def test_update(self, project_files):  # noqa: ANN001, ANN201
    ...
    @pytest.mark.order(7)
    def test_preserve_format(self, project_files):  # noqa: ANN001, ANN201
        meltano_config = project_files.load()
    ...
    @pytest.mark.order(-1)
    def test_remove_all_file_contents(self, project_files):  # noqa: ANN001, ANN201
        meltano_config = project_files.load()
